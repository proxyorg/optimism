...
I finally allow user-made resourcepacks, mods, plugins, datapacks and etc. To submit your work, just make a issue in our [Github](https://github.com/kn0xwya/unbound/issues/new) using the "submission" label and use the following pattern:

Name of the Pack/Mod/Plugin/DataPack: 
Summary of what it does: 
Description (atleast put some work and effort in it please):
Showcase Images:
...
It might take a while for me to review your work and ensure that it is working perfectly but it should get accepted within 24 hours.
<CardGroup cols={2}>
  <Card 
    title="Discover Mods"
    icon= "compass"
