export const HeroCard = ({ img, title, description, href }) => {
  return (
    <a className="border-b pb-8 cursor-pointer border-gray-500 dark:border-gray-800 hover:!border-primary dark:hover:!border-primary-light rounded-lg overflow-hidden" href={href}>
